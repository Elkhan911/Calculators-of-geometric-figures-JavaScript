...
const buttonSub2 = document.querySelector("#_buttonSub2");

const plusBtn = document.querySelector("#_plusBtn");
const minusBtn = document.querySelector("#_minusBtn");
const multiplyBtn = document.querySelector("#_multiplyBtn");
const divideBtn = document.querySelector("#_divideBtn");
const deleteSymbolBtn = document.querySelector("#_deleteSymbol");
const clearSymbolsBtn = document.querySelector("#_clearSymbols");
let secondhint = document.querySelector("#_secondHint");
let thirdHint = document.querySelector("#_thirdHint");
const enterBtn = document.querySelector("#_enterBtn");
const inputCalc = document.querySelector("#_inputCalc");
let calcuResult = document.querySelector("#_calculResult");
const newOperationBtn = document.querySelector("#_newOperationBtn");
